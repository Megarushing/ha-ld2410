...
from .base_light import LD2410SequenceBaseLight
from .device import LD2410EncryptedDevice
...
class LD2410LightStrip(LD2410SequenceBaseLight):
    """Representation of a LD2410 light strip."""
...
class LD2410StripLight3(LD2410EncryptedDevice, LD2410LightStrip):
    """Support for ld2410 strip light3 and floor lamp."""
    ...
    def __init__(
        ...
        encryption_key: str,
        interface: int = 0,
        model: LD2410Model = LD2410Model.STRIP_LIGHT_3,
        **kwargs: Any,
    ) -> None:
