...
from ..api_config import LD2410_APP_API_BASE_URL, LD2410_APP_CLIENT_ID
from ..const import (
    DEFAULT_RETRY_COUNT,
...
class LD2410EncryptedDevice(LD2410Device):
    """A LD2410 device that uses encryption."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """LD2410 base class constructor for encrypted devices."""
        if len(key_id) == 0:
    ...
    async def async_retrieve_encryption_key(
        ...
        """Retrieve lock key from internal LD2410 API."""
        ...
        try:
            ...
            raise LD2410AuthenticationError(f"Authentication failed: {err}") from err
        ...
        try:
            ...
            raise LD2410AccountConnectionError(
                f"Failed to retrieve LD2410 Account user details: {err}"
            ) from err
        ...
        try:
            ...
            raise LD2410AccountConnectionError(
                f"Failed to retrieve encryption key from LD2410 Account: {err}"
            ) from err
    ...
    async def verify_encryption_key(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            return False
        try:
            info = await ld2410_device.get_basic_info()
        except LD2410OperationError:
            return False
