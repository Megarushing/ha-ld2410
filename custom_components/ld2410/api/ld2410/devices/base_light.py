...
from .device import LD2410Device, LD2410OperationError, update_after_operation

_LOGGER = logging.getLogger(__name__)


class LD2410BaseLight(LD2410Device):
    """Representation of a LD2410 light."""
    ...
    async def set_effect(self, effect: str) -> bool:
        ...
        if not effect_template:
            raise LD2410OperationError(f"Effect {effect} not supported")
...
class LD2410SequenceBaseLight(LD2410BaseLight):
    """Representation of a LD2410 light."""
