...
from .device import REQ_HEADER, LD2410DeviceOverrideStateDuringConnection
...
class LD2410PlugMini(LD2410DeviceOverrideStateDuringConnection):
    """Representation of a LD2410 plug mini."""
