...
class LD2410RelaySwitch(LD2410SequenceDevice):
    """Representation of a LD2410 relay switch 1pm."""
    ...
    def __init__(
        ...
        encryption_key: str,
        interface: int = 0,
        model: LD2410Model = LD2410Model.RELAY_SWITCH_1PM,
        **kwargs: Any,
    ) -> None:
    ...
    async def get_basic_info(self) -> dict[str, Any] | None:
        ...
        if self._model == LD2410Model.GARAGE_DOOR_OPENER:
...
class LD2410GarageDoorOpener(LD2410RelaySwitch):
    """Representation of a LD2410 garage door opener."""
    ...
    def __init__(
        ...
        encryption_key: str,
        interface: int = 0,
        model: LD2410Model = LD2410Model.GARAGE_DOOR_OPENER,
        **kwargs: Any,
    ) -> None:
        super().__init__(device, key_id, encryption_key, interface, model, **kwargs)


class LD2410RelaySwitch2PM(LD2410RelaySwitch):
    """Representation of a LD2410 relay switch 2pm."""
    ...
    def __init__(
        ...
        encryption_key: str,
        interface: int = 0,
        model: LD2410Model = LD2410Model.RELAY_SWITCH_2PM,
        **kwargs: Any,
    ) -> None:
        super().__init__(device, key_id, encryption_key, interface, model, **kwargs)
        self._channel = 2
