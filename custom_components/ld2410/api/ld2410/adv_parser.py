...
SUPPORTED_TYPES: dict[str | bytes, LD2410SupportedType] = {
    ...
    "r": {
        "modelName": LD2410Model.LIGHT_STRIP,
    ...
    "g": {
        "modelName": LD2410Model.PLUG_MINI,
    ...
    "e": {
        "modelName": LD2410Model.HUMIDIFIER,
    ...
    "o": {
        "modelName": LD2410Model.LOCK,
        "modelFriendlyName": "Lock",
        "func": process_wolock,
        "manufacturer_id": 2409,
    },
    "$": {
        "modelName": LD2410Model.LOCK_PRO,
    ...
    "<": {
        "modelName": LD2410Model.RELAY_SWITCH_1PM,
        "modelFriendlyName": "Relay Switch 1PM",
        "func": process_relay_switch_1pm,
        "manufacturer_id": 2409,
    },
    ";": {
        "modelName": LD2410Model.RELAY_SWITCH_1,
    ...
    "7": {
        "modelName": LD2410Model.AIR_PURIFIER_TABLE,
