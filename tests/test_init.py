...
async def test_async_setup_entry(hass: HomeAssistant):
    ...
    with (
        patch('homeassistant.components.bluetooth.async_ble_device_from_address') as mock_ble_device,
        patch('custom_components.ld2410.api.switchbot.close_stale_connections_by_address'),
        patch('custom_components.ld2410.SwitchbotDataUpdateCoordinator') as mock_coordinator,
